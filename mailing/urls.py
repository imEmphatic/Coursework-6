...
from . import views
from .views import CustomLoginView, SignUpView, custom_logout, verify_email
...
urlpatterns = [
    ...
    path(
        "mailings/<int:pk>/status/",
        views.MailingStatusView.as_view(),
        name="mailing_status",
    ),
    path("users/", views.UserListView.as_view(), name="user_list"),
    path("users/<int:pk>/block/", views.UserBlockView.as_view(), name="user_block"),
    path(
        "mailing/<int:pk>/deactivate/",
    ...
    path(
        "attempt-stats/",
        views.MailingAttemptStatsView.as_view(),
        name="mailing_attempt_stats",
    ),
    path(
        "attempt-stats/<int:pk>/",
