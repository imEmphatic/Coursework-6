...
class Mailing(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        MailingLog.objects.create(
            mailing=self, status="created", message=f"Mailing {self.id} created"
        )
...
class BlogPost(models.Model):
    ...
    image = models.ImageField(
        upload_to="mailing_images/", blank=True, null=True, verbose_name="Изображение"
    )
